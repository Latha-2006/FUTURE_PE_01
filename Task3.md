...
Write a 20–30 second Instagram Reel ad for a coaching centre.

Structure:
- Hook (attention grabbing)
- Problem (student struggle)
- Solution (how coaching helps)
- CTA (join now)
...
I used to feel confused before exams… no proper guidance, no clarity.

But after joining Bright Future Coaching Centre, everything changed. The teachers explain concepts step-by-step, and now I feel confident.
...
- Introduced role-based prompting (UGC content creator)  
- Defined tone and format for better engagement  
- Improved clarity, structure, and effectiveness of the output  
